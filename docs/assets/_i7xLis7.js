import{i,aa as c,j as d,l as u,N as v}from"./CemJF9AB.js";const I=async()=>({getById:f,getByIds:m,getByEmail:y,save:w,getFollowees:g,saveUserActivity:$,followUser:_,init:S,searchByNameOrEmail:C});async function f(s){var t;const o=i`
    query($id: String) {
